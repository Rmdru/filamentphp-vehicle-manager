...
return [
    ...
    'gasoline_mild_hybrid' => [
        'name' => 'Gasoline + mild-hybrid',
        'unit' => 'liter',
        'unit_short' => 'l',
        'consumption_unit' => 'l/100km',
    ],
    'gasoline_full_hybrid' => [
        'name' => 'Gasoline + full-hybrid',
        'unit' => 'liter',
        'unit_short' => 'l',
        'consumption_unit' => 'l/100km',
    ],
    'gasoline_plugin_hybrid' => [
        'name' => 'Gasoline + plugin-hybrid',
        'unit' => 'liter',
        'unit_short' => 'l',
        'consumption_unit' => 'l/100km',
    ],
    'gasoline_lpg' => [
        'name' => 'Gasoline + autogas (LPG)',
        'unit' => 'liter',
        'unit_short' => 'l',
        'consumption_unit' => 'l/100km',
    ],
    'gasoline_lpg_full_hybrid' => [
        'name' => 'Gasoline + autogas (LPG) + full-hybrid',
        'unit' => 'liter',
        'unit_short' => 'l',
        'consumption_unit' => 'l/100km',
    ],
    'gasoline_cng' => [
        'name' => 'Gasoline + natural gas (CNG)',
        'unit' => 'kilogram',
        'unit_short' => 'kg',
